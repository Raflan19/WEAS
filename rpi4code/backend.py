...
try:
    con = pymysql.connect(host=ip, port=3309, user='root', passwd='root', db='gadget', charset='utf8')
    cmd = con.cursor()
    print("db connected")
...
def location_fetch():
    ...
    con = pymysql.connect(host=ip, port=3307, user='root', passwd='root', db='gadget', charset='utf8')
    cmd = con.cursor()
    if button_pressed:
